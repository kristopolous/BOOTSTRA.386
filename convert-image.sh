...
ascii() {
  ...
  convert $1 -remap img/ega16-palette.png -resize 70x $tmp
  img2txt -W 30 -x 12.4 -y 20 -f tga $1 | convert tga:- $1
  rm $tmp
}

color16() {
  convert $1 -resize 120x - | convert - -filter box -dither FloydSteinberg -remap img/ega16-palette.png -resize 360x $1
}
color16 $1
