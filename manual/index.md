...
As we ate our pizza, Gilda, a gifted Engineer from overseas, pointed out that this was only going to be useful if non-technical people, without reading manuals, were able to effectively use the computers.

"This is a monumental task", she said, while munching on a slice of pizza, "think about the desk calculator. We can't effecively explain the memory and percent buttons to people, how do you expect those same people to typeset a sales report by themselves?"
...
The drive on Sunday to Vegas was a bit much for the 1973 Winnebego. It was the only vehicle that we could plug a power strip into. Comdex is crucial. If you miss it, then you might as well just go out of business.
...
The back of the Winnebego had 5 kids sitting around 3 microcomputers as I drove down the I-5 past fields of food and cows. So many fragrant cows.

If you haven't had the chance to use a computer yet let me introduce you to the strangeness. You turn it on and the box sounds like it needs muffler. The machine chirps a beep as the screen turns on and you see an incrementing number in the top left. It will go up into the hundreds in increments of 16. This checks what is known as volatile memory, it's what the computer needs to shuffle things around in its brain.

A top of the line computer these days will go up to 640. This takes minutes. Enough for you to make a cup of coffee. 

And then the diskette drives make a disturbing crunching sound as their lights go red, looking to see if anything is there. If it's not, then the default system loads. 

Regardless of the computer there is eventually a prompt which consists of a series of characters followed by a blinking rectangle and then you, the user are tasked with instructing the computer what to do through terse languages with names like "CP/M" and "MS-DOS". Yes, it's all caps with characters in between them. For the first you just say the letters and omit the slash. The second is not Ms. Dos nor is it all the letters, but the MS is spoken and the DOS part rhymes with loss.
...
Everyone assumes this will be inevitable and people will do all kinds of things on these machines. Look up recipes, casually chat with friends, even store home videos and their record collection. On the black screen with the blinking rectangle.
...
Silicon Valley seems obvious since I already knew the future and they will just hire anyone off the street if they sound like they can hack it. This sounds like it would be easy. I had alsways admired BOOTSTRA and BOOTSTRA/386 as revolutionary products in the mid-1980s ever since reading Tracy Kiddel's masterpiece on its development.
...
The cheap motel I'm staying in is going to be torn down after Loma Linda, replaced with a mall, which will then get torn down and replaced with a 5-over-1 in 2023 but right now it's $15.99/night. 1984 prices, gotta love them.

I guess I get the weekend to myself. It's weird to walk around the place you grew up in and seeing a bunch of things you don't recognize. My favorite third-wave coffee house is a music store with the name "Sam Goody", in the distance all I see is smog and the most exotic foreign food I can find is sushi.

There's all these details you forget about until you're there. People purchasing newspapers from newstands, cigarette vending machines in diners hazes of smoke on the ceilings. Even the cars. You think you know what the cars are going to be.  Did you know that not all cars had side-view mirrors on both sides? There's a bunch without them. 

Even the lights are different. They have harsh bright glows and buzzing sounds, flickering like some kind of video game. And then there's the lack of phones. I've got mine back at the hotel room, sure, along with my mdoern laptop and USB power brick ... I wasn't going to travel completely empty-handed.

But it's not jsut phones, it's screens in general. Small CRTs flicker everywhere with washed out color and have this high pitched squeal when you turn them on. 40 years ago can feel so familiar yet at the same time, so foreign. The NES version of Super Mario Bros is still 18 months in the future.
